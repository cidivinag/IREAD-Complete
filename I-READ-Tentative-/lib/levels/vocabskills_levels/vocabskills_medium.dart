...
class VocabSkillsMedium extends StatefulWidget {
  const VocabSkillsMedium({super.key});

  @override
  _VocabSkillsMediumState createState() => _VocabSkillsMediumState();
}

class _VocabSkillsMediumState extends State<VocabSkillsMedium> {
  ...
  Future<List<Module>> _fetchMediumModules() async {
    ...
    return modules
        .where((module) =>
            ...
            module.category == 'Vocabulary Skills')
        .toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        Navigator.pushNamed(context, '/vocabskills_levels');
