...
class VocabSkillsHard extends StatefulWidget {
  const VocabSkillsHard({super.key});

  @override
  _VocabSkillsHardState createState() => _VocabSkillsHardState();
}

class _VocabSkillsHardState extends State<VocabSkillsHard> {
