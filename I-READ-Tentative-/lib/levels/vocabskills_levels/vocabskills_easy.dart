...
class VocabSkillsEasy extends StatefulWidget {
  const VocabSkillsEasy({super.key});

  @override
  _VocabSkillsEasyState createState() => _VocabSkillsEasyState();
}

class _VocabSkillsEasyState extends State<VocabSkillsEasy> {
